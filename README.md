...
The precomputed segmentation results (UCM2, generated by RCF+COB) for BSDS500 and NYUD datasets are available [here](https://github.com/yun-liu/RCF/releases/download/v1.0/RCF_Segment.zip).
...
The code for the ResNet version of RCF has been released. The pretrained ImageNet and BSDS500 models are available here ([RCF-ResNet50](https://github.com/yun-liu/RCF/releases/download/v1.0/rcf_resnet50_bsds_iter_40000.caffemodel) | [RCF-ResNet101](https://github.com/yun-liu/RCF/releases/download/v1.0/rcf_resnet101_bsds_iter_40000.caffemodel)). Some discussion can be found under the [issue #89](https://github.com/yun-liu/rcf/issues/89).
