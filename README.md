...
For the PyTorch implementation of RCF, please refer to this [github repository](https://github.com/balajiselvaraj1601/RCF_Pytorch_Updated). Thanks for the Balaji's contribution! According to the [issue #134](https://github.com/yun-liu/RCF/issues/134), this PyTorch implementation can reproduce the accuracy of the Caffe version.
